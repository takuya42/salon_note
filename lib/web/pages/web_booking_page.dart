    ...
    return WebPageShell(
      child: shopAsync.when(
        data: (shop) {
          ...
          if (!displayShop.webEnabled && !useDummyMenus) {
            return const Center(child: Text('現在Web予約は公開されていません'));
          }
